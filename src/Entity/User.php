...
//    use CreatedUpdatedDeletedAtAndByTrait;
    ...
    /**
     * @var Collection<int, LiveStream>
     */
    #[ORM\OneToMany(targetEntity: LiveStream::class, mappedBy: 'user')]
    ...
    public function removeLiveStream(LiveStream $liveStream): static
    {
        if ($this->liveStreams->removeElement($liveStream)) {
            ...
            if ($liveStream->getUser() === $this) {
                $liveStream->setUser(null);
            }
        }
